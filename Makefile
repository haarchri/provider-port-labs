...
PROJECT_NAME ?= provider-portlabs
PROJECT_REPO ?= github.com/haarchri/$(PROJECT_NAME)

export TERRAFORM_VERSION ?= 1.2.1

export TERRAFORM_PROVIDER_SOURCE ?= port-labs/port-labs
export TERRAFORM_PROVIDER_REPO ?= https://github.com/port-labs/terraform-provider-port-labs
export TERRAFORM_PROVIDER_VERSION ?= 1.5.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-port-labs
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-port-labs_v1.5.0
...
xpkg.build.provider-portlabs: do.build.images
...
#   You can check the basic implementation here: https://github.com/upbound/uptest/blob/main/internal/portlabss/01-delete.yaml.tmpl.
